...
export class Game {
  ...
  private moveSound = ["/sfx/move1.mp3", "/sfx/move2.mp3"];
  private captureSound = ["/sfx/capture1.mp3", "/sfx/capture2.mp3"];
  private looseSound = ["/sfx/loose.mp3", "/sfx/final-move.mp3"];
